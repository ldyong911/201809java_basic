	...
	public static void main(String[] args) {
		/*
			...
			*[6-8] 다음의 코드에 정의된 변수들을 종류별로 구분해서 적으시오.
			...
			weapon과 armor는 모든 병사의 공격력과 방어력은 같아야 하기 때문에,
			weaponUp()과 armorUp()은 weapon과 armor를 사용하는 메서드 이기 때문에 
			...
			*[6-16] 다음 중 지역변수에 대한 설명으로 옳지 않은 것은? (모두 고르시오)
			...
			[답]
			라인 A, 라인 B, 라인 D
			클래스변수에 인스턴스 변수를 사용할 수 없으며 사용하고 싶으면 인스턴스화를 해야한다
			클래스메서드에 인스턴스 변수를 사용할 수 없다
			클래스메서드에 인스턴스 메서드를 사용할 수 없다
			
			*[6-19] 다음 코드의 실행 결과를 예측하여 적으시오.  //String은 참조형이지만 내부적으로는 char[] 형태의 배열인데 변수자체를 
			[연습문제]/ch6/Exercise6_19.java             //새로 생성해야 값을 조작할 수 있음
			class Exercise6_19
			{
