...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(str.split(" "))); //공백 1개
		System.out.println(Arrays.toString(str.split(" +"))); //정규표현식 +에 의해 공백 1개이상
		...
		System.out.println(str.toUpperCase().toLowerCase()); //str.toUpperCase() 결과가 스트링이라 가능
